...
extern const uchar		NetBcastAddr[6];	/* Ethernet boardcast address	*/
...
typedef enum { BOOTP, RARP, ARP, TFTP, DHCP, PING, DNS, NFS, CDP, NETCONS, AMCDDP } proto_t;
...
#if 1
/********************/
/* AMCDDP public interface definition begins */
#define	CFG_AMCDDP_USE_UBOOT_IP

typedef enum {
	AMCCmdReq_SearchForUtility = 0,
	AMCCmdReq_RequestUpgradeFile,
	AMCCmdReq_RequestMd5Digest,
} AMCDdpCmdRequest_t;

extern void AMCDdpSetCmdRequest(AMCDdpCmdRequest_t req);
extern void *AMCDdpFileStart(void);
extern unsigned long AMCDdpFileLength(void);
extern void AMCDdpSetMd5Buffer(unsigned char *md5Buffer);


/* AMCDDP public interface definition ends */
/********************/
#endif
