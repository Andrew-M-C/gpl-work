...
/*	STATE_MACHINE_FUNC		ApDlsFunc[DLS_FUNC_SIZE]; */
	...
	RALINK_TIMER_STRUCT DeauthTimer;
	PUCHAR pDeauthOutBuffer;
	ULONG DeuthOutBufferLen;
#endif
	ULONG PeriodicRound;
	ULONG GPIORound;
...
typedef struct _APCLI_STRUCT {
	...
	UCHAR LinkIdx;
	PVOID pAd;
	UCHAR bMixPskMode;	/* indicate current setting is auto auth(WPAPSK/WPA2PSK)/encryp(TKIP/AES) or not , by zb 2014/1/17*/
