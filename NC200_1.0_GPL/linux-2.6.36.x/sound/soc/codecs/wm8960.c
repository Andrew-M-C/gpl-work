...
static int wm8960_mute(struct snd_soc_dai *dai, int mute)
{
	...
	//printk("[hehe]reg:%02x val:%02x\n",0x28,(unsigned int)(snd_soc_read(codec, 0x28))); 
	//printk("[hehe]reg:%02x val:%02x\n",0x29,(unsigned int)(snd_soc_read(codec, 0x29)));
	//printk("[hehe]reg:%02x val:%02x\n",0x00,(unsigned int)(snd_soc_read(codec, 0x00))); 
	//printk("[hehe]reg:%02x val:%02x\n",0x01,(unsigned int)(snd_soc_read(codec, 0x01))); 
	//printk("[hehe]reg:%02x val:%02x\n",0x15,(unsigned int)(snd_soc_read(codec, 0x15))); 
	//printk("[hehe]reg:%02x val:%02x\n",0x16,(unsigned int)(snd_soc_read(codec, 0x16)));
	snd_soc_write(codec,0x00, 0x13f);//0x13f
	snd_soc_write(codec,0x01, 0x13f); 
	//snd_soc_write(codec,0x15, 0x1ff); 
	//snd_soc_write(codec,0x16, 0x1ff); 
	//printk("[hehe]reg:%02x val:%02x\n",0x28,(unsigned int)(snd_soc_read(codec, 0x28))); 
	//printk("[hehe]reg:%02x val:%02x\n",0x29,(unsigned int)(snd_soc_read(codec, 0x29)));
	//printk("[hehe]reg:%02x val:%02x\n",0x00,(unsigned int)(snd_soc_read(codec, 0x00))); 
	//printk("[hehe]reg:%02x val:%02x\n",0x01,(unsigned int)(snd_soc_read(codec, 0x01))); 
	...
	//printk("[hehe]reg:%02x val:%02x\n",WM8960_LINPATH,(unsigned int)(snd_soc_read(codec, WM8960_LINPATH))); 
	if (mute)
