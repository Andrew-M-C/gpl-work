...
/*
				...
				offset: 		MTDPART_OFS_APPEND,
*/
				size:			CONFIG_MTD_KERN_PART_SIZE ,				/* 2M */
				offset: 		MTDPART_OFS_APPEND,
		}, {
				name:			"UsrLocal", /* mtdblock4 */
				size:			CONFIG_MTD_PHYSMAP_LEN - MTD_BOOT_PART_SIZE - MTD_CONFIG_PART_SIZE - MTD_FACTORY_PART_SIZE - CONFIG_MTD_KERN_PART_SIZE - 0x100000,
				offset: 		MTDPART_OFS_APPEND,
		}, {
                name:           "IPCConfig",
                size:           0x100000,
