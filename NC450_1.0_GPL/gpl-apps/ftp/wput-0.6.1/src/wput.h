...
#ifdef MY_FEATURE
#define FTP_ERROR_CODE_UNKNOW		-1
#define FTP_ERROR_CODE_SUCCESS		0
#define FTP_ERROR_CODE_NETWORK		1
#define FTP_ERROR_CODE_LOGIN			2
#define FTP_ERROR_CODE_PATH			3
#define FTP_ERROR_CODE_PERMISSION		4
#define FTP_ERROR_CODE_MODE			5
#define FTP_ERROR_CODE_INTERNAL		6
#endif
